"""
Ferguson Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Ferguson.

Docs  : https://docs.brightdata.jp/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.jp/products/insights/price-tracker/ferguson
"""
...
# Set your Web Scraper ID after building your Ferguson scraper:
# https://brightdata.jp/products/web-scraper/ferguson
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Ferguson scraper at: https://brightdata.jp/products/web-scraper/ferguson\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Ferguson product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Ferguson products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Ferguson category page.

    Example:
        results = discover_by_category("https://ferguson.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.ferguson.com/product/sample-item-123456",
        # Add more Ferguson product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "ferguson_prices.json"
    ...
    # cat_results = discover_by_category("https://ferguson.com/category/sample", limit=50)
